...
function Index() {
  ...
  return (
    <>
      ...
      <footer className="border-t border-border pt-14 pb-10 text-center text-sm text-muted-foreground">
        {/* Brand */}
        <p className="font-serif text-3xl font-bold tracking-tight text-foreground">AB CREATIVE</p>
        <p className="mt-2 text-base text-muted-foreground">Capturing moments beautifully.</p>

        {/* Category tags */}
        <div className="mt-4 flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-xs text-muted-foreground">
          {["Wedding", "Couple", "Portrait", "Event Photography"].map((cat, i, arr) => (
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <a
            ...
            className="group inline-flex items-center gap-2 rounded-full border border-border bg-secondary/40 px-4 py-2 text-xs font-semibold transition-all hover:border-pink-500/50 hover:bg-pink-500/10 hover:text-pink-500"
          >
            <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 shrink-0" fill="currentColor" aria-hidden="true">
              <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324zM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8zm6.406-11.845a1.44 1.44 0 1 0 0 2.881 1.44 1.44 0 0 0 0-2.881z" />
            </svg>
            <span className="relative inline-block overflow-hidden">
              <span className="block transition-all duration-300 group-hover:-translate-y-full group-hover:opacity-0">Instagram</span>
              <span className="absolute inset-0 flex items-center translate-y-full opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">Follow ↗</span>
            </span>
          </a>
          ...
          <a
            ...
            rel="noreferrer"
            aria-label="YouTube"
            className="group inline-flex items-center gap-2 rounded-full border border-border bg-secondary/40 px-4 py-2 text-xs font-semibold transition-all hover:border-[#FF0000]/50 hover:bg-[#FF0000]/10 hover:text-[#FF0000]"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="h-3.5 w-3.5 shrink-0">
              <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
            </svg>
            <span className="relative inline-block min-w-[4.5rem] overflow-hidden text-center">
              <span className="block transition-all duration-300 group-hover:-translate-y-full group-hover:opacity-0">YouTube</span>
              <span className="absolute inset-0 flex items-center justify-center translate-y-full opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">Subscribe</span>
            </span>
          </a>
          ...
          <a
            ...
            rel="noreferrer"
            aria-label="WhatsApp"
            className="group inline-flex items-center gap-2 rounded-full border border-border bg-secondary/40 px-4 py-2 text-xs font-semibold transition-all hover:border-[#25D366]/50 hover:bg-[#25D366]/10 hover:text-[#25D366]"
          >
            <MessageCircle className="h-3.5 w-3.5 shrink-0" />
            <span className="relative inline-block overflow-hidden">
              <span className="block transition-all duration-300 group-hover:-translate-y-full group-hover:opacity-0">WhatsApp</span>
              <span className="absolute inset-0 flex items-center translate-y-full opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">Chat Now</span>
            </span>
          </a>
        </div>

        {/* Divider */}
        <div className="mx-auto mt-12 max-w-xs border-t border-border/50" />

        {/* Bottom bar */}
        <div className="mt-6 space-y-1.5">
          <p>
            © {new Date().getFullYear()} AB Creative. All rights reserved by{" "}
            <a
              href="https://rohanrathod.vercel.app/"
              target="_blank"
              rel="noreferrer"
